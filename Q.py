...
"""%(N))                                                    
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Admin       : Tajul Islam Rabbi
 [\x1b[1;96m+%s] WhatsApp   : 
 [\x1b[1;96m+%s] Facebook   : Tajul Islam Rabbi
 [\x1b[1;96m+%s] Github      : https://github.com/Hacker1414
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
def kontol():
    os.system("clear")
    print(f""" 
...
{P}[•]{B}----------------------------------------------------{P}[•]
{B} |
{P}[•] ADMKN LISESI : Faz Tajul Islam Rabbi
{P}[•] WHATSAPP : 01814032575
{P}[•] FACEBOOK : Tajul Islam Rabbi""")
def licensi():#line:42
  try :#line:43
    os .system ('clear')
    kontol()
